...
using Images, PyCall, PlutoUI, LinearAlgebra, DSP
...
# ╔═╡ 504feb32-c05f-4e43-95ea-58c704dbbe29
pattern = [
	2 1;
	3 2
]
...
# ╔═╡ a1be75f8-8216-4486-a6d3-8959426c1e5d
size(grayscale)

# ╔═╡ d2c80821-b50d-4f1c-a2dd-7fe0941d0698
function fill_rgb_in_idx(idx, val)
	rgb = [.0, .0, .0]
	rgb[idx] = val
	RGB(rgb...)
end
...
# ╔═╡ edf6eb2d-cd7a-4e3f-8934-4929b4f2bd7d
grayscale[:, 1]

# ╔═╡ 7502e42a-c2e7-4187-a17f-e012b46447e3
green_idxs

# ╔═╡ 57448e18-4076-47c2-a903-37b1cf05e20e
blue_idxs

# ╔═╡ 10e90be9-61ad-4e36-8c78-9cbda5830d9e
red_idxs

# ╔═╡ 59fbfc14-7e99-44d2-808c-2f078f410fb8
blank_img = zeros(size(grayscale));

# ╔═╡ b66d8053-e997-4dc9-a4f6-c104d35296cb
begin
	red_img =  zeros(rows * cols)
	red_img[red_idxs] = grayscale[red_idxs]
	red_img = reshape(red_img, (rows, cols))
end

# ╔═╡ 959b2bcf-35c6-460b-83c5-5f9822c0d5d9
begin
	green_img =  zeros(rows * cols)
	green_img[green_idxs] = grayscale[green_idxs]
	green_img = reshape(green_img, (rows, cols))
end

# ╔═╡ 92503812-00a0-4cd2-b603-e64e2a9c8e12
green_img .|> Gray
...
@bind idx Slider(1:rows-sz)

# ╔═╡ aa1cb373-2b3e-496c-a18f-7349cd23f2d3
green_img[idx:idx+sz, idx:idx+sz] .|> Gray

# ╔═╡ a7c27db5-be49-4571-a775-a576e457e153
empty_img = zeros(size(mosaic_img))
...
# ╠═10e90be9-61ad-4e36-8c78-9cbda5830d9e
# ╠═59fbfc14-7e99-44d2-808c-2f078f410fb8
# ╠═57defd6b-e13f-4685-96de-acb6b35a9134
# ╠═b66d8053-e997-4dc9-a4f6-c104d35296cb
# ╠═959b2bcf-35c6-460b-83c5-5f9822c0d5d9
# ╠═92503812-00a0-4cd2-b603-e64e2a9c8e12
# ╠═db0ede9b-b7f7-478f-a01f-2a79a4310352
